        ...
        <div className="col">
          ...
          <Section title="About me">
            ...
            <Paragraph>
              ...
              in and recognize the importance of <b>UX/UI design</b>. Currently,
              I am honing my technologies in this area using Figma as a design
              tool and applying design patterns, Nielsen heuristics,
              Shneiderman's Golden Rules, among others.
            </Paragraph>
          </Section>
